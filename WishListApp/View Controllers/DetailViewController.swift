...
//  WishListApp
//
//  Created by Ольга Горбачева on 28.11.21.
//
...
//
    private func setupInstructionButton() {
        ...
        instructionsButton.setTitle("Cooking Steps", for: .normal)
        instructionsButton.setTitleColor(.darkText, for: .normal)
        instructionsButton.backgroundColor = UIColor(named: "fastFoodColour")
